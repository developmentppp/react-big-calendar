  ...
  return _createClass(EventRow, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        if (gap) row.push(_EventRowMixin.default.renderSpan(_this.props, gap, key + '_gap'));
        row.push(_EventRowMixin.default.renderSpan(_this.props, span, key, content));
        lastEnd = right + 1;
        return row;
      }, []));
    }
...
_defineProperty(EventRow, "propTypes", _objectSpread({
  segments: _propTypes.default.array
}, _EventRowMixin.default.propTypes));
_defineProperty(EventRow, "defaultProps", _objectSpread({}, _EventRowMixin.default.defaultProps));
